 ...
 *
 * Loads the tsparticles snow preset and mounts it into a dedicated container element. The container
 * is created on demand so the effect is fully self-contained and leaves no markup in the document
 * until it runs.
 */
